                ...
                <div class="card scroll-box">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <div class="input-group">
                                    <button type="submit" @click="listarInventario(1,buscar)" class="btn btn-primary"><i class="fa fa-refresh"></i> Actualizar</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="inventario in arrayInventario" :key="inventario.id">
                                        <td>
                                            <button type="button" @click="abrirModal('ver',inventario)" class="btn btn-primary btn-sm">
                                                <i class="icon-eye"></i>
                                            </button>
                                        </td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile3" role="tabpanel">2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut 
                            ...
                            <div class="tab-pane" id="messages3" role="tabpanel">3. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt 
